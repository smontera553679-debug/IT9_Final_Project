    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .subtitle {
            ...
            color: #333;
            margin: 6px 0 clamp(24px, 5vw, 40px);
        }
...
<div class="login-card">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="input-group">
            ...
            <input type="text" name="username" id="username" placeholder="Juan Dela Cruz" required value="{{ old('username') }}">
        </div>
        ...
        <div class="input-group has-toggle">
            ...
            <button type="button" class="toggle-pw" onclick="togglePassword('password', this)" aria-label="Show password">
                <svg id="eye-password" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="{{ route('register') }}" class="footer-link">Don't have an account?</a>
    </form>
</div>
