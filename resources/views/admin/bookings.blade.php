...
@section('content')
<style>
    .bookings-wrap .page-title { color: var(--text-title); transition: color 0.3s ease; }
    ...
    .bookings-wrap .table-responsive { background: var(--bg-navbar); transition: background 0.3s ease; }
    ...
    .bookings-wrap .table-hover tbody tr:hover > * { background-color: var(--notif-hover) !important; }
    ...
    .bookings-wrap .table-clip { border-radius: 15px 15px 0 0; overflow: hidden; }

    .bookings-wrap .booking-id { color: #a78bfa; font-weight: 700; }
    .bookings-wrap .col-muted { color: var(--text-muted); transition: color 0.3s ease; }
    .bookings-wrap .empty-state { color: var(--text-time); font-size: 0.88rem; transition: color 0.3s ease; }
...
<div class="bookings-wrap container-fluid py-3 py-md-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-0">
            ...
            @include('components.pagination', ['paginator' => $bookings, 'label' => 'bookings'])
        </div>
    </div>
</div>
@endsection