...
<head>
    ...
    <style>
        ...
        @media (max-width: 1024px) {
            ...
            .nav-grid { grid-template-columns: 1fr auto; height: 70px; }
            .nav-center-wrapper { display: none; }
            .hamburger-btn { display: flex; }
            .admin-logo { height: 56px !important; }
...
<nav class="navbar">
    <div class="nav-grid">
        ...
        <div class="nav-left">
            <a class="logo-container" href="{{ route('admin.dashboard') }}">
                <img src="{{ asset('images/bytetrip_logo-Picsart-BackgroundRemover-removebg-preview.png') }}" alt="ByteTrip Logo" class="admin-logo">
            </a>
        </div>
        ...
        <div class="nav-center-wrapper">
            <ul class="navbar-nav">
                <li><a class="nav-link {{ Route::is('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                <li><a class="nav-link {{ Request::is('admin/destinations*') ? 'active' : '' }}" href="{{ route('destinations.index') }}">Destinations</a></li>
                <li><a class="nav-link {{ Request::is('admin/packages*') ? 'active' : '' }}" href="{{ route('packages.index') }}">Packages</a></li>
                <li><a class="nav-link {{ Request::is('admin/bookings*') ? 'active' : '' }}" href="{{ route('bookings.index') }}">Bookings</a></li>
                <li><a class="nav-link {{ Request::is('admin/customers*') ? 'active' : '' }}" href="{{ route('customers.index') }}">Customers</a></li>
                <li><a class="nav-link {{ Request::is('admin/payments*') ? 'active' : '' }}" href="{{ route('payments.index') }}">Payments</a></li>
            </ul>
        </div>
            ...
            <div class="dropdown">
                <button class="profile-btn dropdown-toggle" type="button" id="profileDropdown"
                    ...
                    <img src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->fullname) . '&background=random&color=fff' }}"
                         width="42" height="42" class="profile-img">
                </button>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                    <li class="px-4 py-2">
                        <span class="d-block" style="font-size:0.7rem;font-weight:700;text-transform:uppercase;color:var(--text-muted);">Administrator</span>
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.archive') }}"><i class="fa fa-archive me-2" style="color:var(--text-muted);"></i> Archive</a></li>
                    <li><a class="dropdown-item" href="{{ route('admin.user-guide') }}"><i class="fa fa-book me-2" style="color:var(--text-muted);"></i> User Guide</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
...
<div class="mobile-menu" id="mobileMenu">
    <a class="mobile-nav-link {{ Route::is('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">
        <i class="fas fa-tachometer-alt me-2"></i> Dashboard
    </a>
    <a class="mobile-nav-link {{ Request::is('admin/destinations*') ? 'active' : '' }}" href="{{ route('destinations.index') }}">
        <i class="fas fa-map-marked-alt me-2"></i> Destinations
    </a>
    <a class="mobile-nav-link {{ Request::is('admin/packages*') ? 'active' : '' }}" href="{{ route('packages.index') }}">
        <i class="fas fa-box-open me-2"></i> Packages
    </a>
    <a class="mobile-nav-link {{ Request::is('admin/bookings*') ? 'active' : '' }}" href="{{ route('bookings.index') }}">
        <i class="fas fa-calendar-check me-2"></i> Bookings
    </a>
    <a class="mobile-nav-link {{ Request::is('admin/customers*') ? 'active' : '' }}" href="{{ route('customers.index') }}">
        <i class="fas fa-users me-2"></i> Customers
    </a>
    <a class="mobile-nav-link {{ Request::is('admin/payments*') ? 'active' : '' }}" href="{{ route('payments.index') }}">
